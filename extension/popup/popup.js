...
class PopupController {
  ...
  renderActiveMedia() {
    ...
    if (isPending) {
      ...
      sectionLabel.textContent = 'Resuming…';
    } else {
    ...
    if (isPending) {
      typeBadge.textContent = 'RESUMING';
    ...
    // Source (site name / desktop app name)
    const sourceEl = document.getElementById('activeSource');
    sourceEl.textContent = isDesktop
      ? (displayMedia.appId || 'Desktop app')
      : this.getSourceName(displayMedia.url);
